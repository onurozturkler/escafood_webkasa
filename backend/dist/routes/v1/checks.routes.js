...
checksRouter.post("/in", uploadRateLimiter, uploaders.checks.array("attachments", 5), validate(checkInSchema), CheckController.registerIn);
checksRouter.post("/out", uploadRateLimiter, uploaders.checks.array("attachments", 5), validate(checkOutSchema), CheckController.registerOut);
checksRouter.post("/issue", uploadRateLimiter, uploaders.checks.array("attachments", 5), validate(issueSchema), CheckController.issueCompanyCheck);
