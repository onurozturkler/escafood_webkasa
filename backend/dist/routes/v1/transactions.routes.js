...
const bankOutSchema = z
    ...
    .refine((data) => data.category !== TransactionCategory.KK_ODEME || !!data.contactId, "KK ödemesi için tedarikçi seçiniz");
const posSchema = z
    .object({
    ...baseTransactionSchema,
    bankAccountId: z.string().uuid(),
...
transactionsRouter.post("/card-expense", uploadRateLimiter, uploaders.slips.array("attachments", 5), validate(cardExpenseSchema), TransactionController.cardExpense);
